        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-[14px] shadow-[0_2px_8px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-8">
            <div className="text-center space-y-4">
              ...
              <Link href="/login" className="block mt-2 text-sm text-[#0891B2] hover:underline font-medium">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-[14px] shadow-[0_2px_8px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-8">
          ...
          <form action={formAction} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full h-11 bg-[#0891B2] hover:bg-[#0F2A6B] text-white font-semibold rounded-lg" 
              disabled={isPending}
            >
              {isPending ? (
                <>
          ...
          <p className="mt-6 text-center text-sm text-[#6B7280]">
            Ingat password?{' '}
            <Link href="/login" className="text-[#0891B2] font-medium hover:underline">
              Masuk sekarang
            </Link>
          </p>
        </div>
